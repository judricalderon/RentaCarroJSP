...
/**
 * La clase VehiculoDTO representa un vehículo en formato de transferencia de datos (DTO).
 */
public class VehiculoDTO {
    ...
    /**
     * Constructor para crear un objeto VehiculoDTO.
     ...
     */
	public VehiculoDTO(int id, String imagen, String tipo, String marca, String modelo, String anio, int precioAlquiler,
